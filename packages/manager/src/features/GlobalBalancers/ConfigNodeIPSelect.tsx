...
import { getPublicIPOptions } from './ConfigNodeIPSelect.utils';
...
export const ConfigNodeIPSelect = React.memo((props: Props) => {
  ...
  const { data: nodebalancers, error2, isLoading2 } = useAllNodeBalancersQuery();

  const options = getPublicIPOptions(linodes, nodebalancers);
