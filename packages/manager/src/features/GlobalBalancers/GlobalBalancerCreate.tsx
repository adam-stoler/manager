...
import { GlobalBalancerConfigPanel } from './GlobalBalancerConfigPanel';
import {
  createNewNodeBalancerConfig,
  createNewNodeBalancerConfigNode,
  transformConfigsForRequest,
} from '../NodeBalancers/utils';

import type { NodeBalancerConfigFieldsWithStatus } from '../NodeBalancers/types';
...
const GlobalBalancerCreate = () => {
  ...
  return (
    <React.Fragment>
      <DocumentTitleSegment segment="Create a GlobalBalancer" />
      <LandingHeader
        breadcrumbProps={{
          breadcrumbDataAttrs: {
            'data-qa-create-nodebalancer-header': true,
          },
          crumbOverrides: [{ label: 'GlobalBalancers', position: 1 }],
          pathname: '/globalbalancers/create',
        }}
        title="Create"
      />
...
export const globalBalancerCreateLazyRoute = createLazyRoute(
  '/balancers/create'
)({
  component: GlobalBalancerCreate,
});

export default GlobalBalancerCreate;
